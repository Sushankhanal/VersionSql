/****** Object:  Procedure [dbo].[sp_tblCardOwner_Update]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_tblCardOwner_Update]
...
declare
	...
	@CardOwnerId        bigint,
	@CardId             bigint
EXEC	@return_value= [dbo].[Local_sp_tblCardOwner_Update]
		@intID,
	@strFirstName,
	@strMobileNumber,
	@intGender,
...
EXEC [dbo].[Sync_CardInsertUpdate] @CardId = @CardId;
    ...
    begin
	 EXEC[dbo].[Local_sp_tblCardOwner_Update]
			@intID,
	@strFirstName,
	@strMobileNumber,
	@intGender,
