/****** Object:  Procedure [dbo].[api2_tblCard_Trans_Void]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[api2_tblCard_Trans_Void]
...
EXEC @return_value= [dbo].[Local_api2_tblCard_Trans_Void]
		@strCardNumber,
		@strUniqueKey,
		@cardid output;
...
END CATCH
    ...
    begin
	 EXEC[dbo].[Local_api2_tblCard_Trans_Void]
		@strCardNumber,
		@strUniqueKey
