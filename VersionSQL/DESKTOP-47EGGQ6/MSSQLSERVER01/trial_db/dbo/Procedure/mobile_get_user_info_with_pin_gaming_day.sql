/****** Object:  Procedure [dbo].[mobile_get_user_info_with_pin_gaming_day]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[mobile_get_user_info_with_pin_gaming_day] @card_sn    NVARCHAR(50), 
                                                                 @pin        NVARCHAR(50), 
                                                                 @machine_id BIGINT, 
                                                                 @start      DATETIME, 
                                                                 @end        DATETIME
                ...
                BEGIN
                    ...
                    (
                        ...
                        WHERE CardPointTrans_SerialNo = @card_sn
                              AND tblCardPointTrans.CardPointTrans_PointType = 0
                              AND tblCardPointTrans.CardPointTrans_Type = 12
