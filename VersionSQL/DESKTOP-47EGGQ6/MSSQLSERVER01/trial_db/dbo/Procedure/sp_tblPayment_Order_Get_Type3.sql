/****** Object:  Procedure [dbo].[sp_tblPayment_Order_Get_Type3]    Committed by VersionSQL https://www.versionsql.com ******/

-- exec sp_tblPayment_Order_Get_Type3 'COUNTER-10','comp02',''
CREATE PROCEDURE [dbo].[sp_tblPayment_Order_Get_Type3] (
...
BEGIN
	...
	H.Payment_TableCode as TableCode
