/****** Object:  Procedure [dbo].[mobile_user_mobile_verification_forgot_password]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[mobile_user_mobile_verification_forgot_password]
...
BEGIN
	...
	BEGIN TRY  
		...
		@random_key
		WHERE
		(SELECT COUNT(*) FROM tblUserMobile WHERE mUser_MobileNo = @mobileNo AND mUser_Status = 1) = 1
