/****** Object:  Procedure [dbo].[Local_mobile_get_user_info_gaming_day_3rd]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Local_mobile_get_user_info_gaming_day_3rd] @card_sn        NVARCHAR(50), 
                                                            @machine_id     BIGINT, 
                                                            @start          DATETIME, 
                                                            @end            DATETIME, 
...
AS
    BEGIN
        ...
        BEGIN TRY
            ...
            DECLARE @PlayerLevel_ID BIGINT= 0;
            SELECT @PlayerLevel_ID = PlayerLevel_ID
            FROM tblPlayerLevel
            WHERE PlayerLevel_Name = 'Normal'
