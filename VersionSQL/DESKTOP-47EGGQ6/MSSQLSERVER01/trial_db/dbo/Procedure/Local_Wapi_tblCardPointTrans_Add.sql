/****** Object:  Procedure [dbo].[Local_Wapi_tblCardPointTrans_Add]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE [dbo].[Local_Wapi_tblCardPointTrans_Add]
...
BEGIN
	...
	Declare @strResultText nvarchar(255) = ''
		...
		BEGIN
			...
			SET @strManagerUserCode = @strUsername
			...
			BEGIN
				...
				BEGIN
					set @intResultCode = -1
					set @strResultText = 'Total Point can not adjust to negative.'
			...
			CardPointTrans_CampaignCode, CardPointTrans_QRCodeText, CardPointTrans_WalletAmt, CardPointTrans_Ratio,  CardPointTrans_BranchID,
			...
			@intPlayerID,@strRemarks,@intCreatedBy,GETDATE(),
			'','',0,0,0, @strManagerUserCode, GETDATE(), @intPointType)
