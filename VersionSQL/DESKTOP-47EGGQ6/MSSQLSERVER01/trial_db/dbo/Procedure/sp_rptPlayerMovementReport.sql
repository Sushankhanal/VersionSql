/****** Object:  Procedure [dbo].[sp_rptPlayerMovementReport]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE [dbo].[sp_rptPlayerMovementReport]
...
BEGIN
	...
	--3 FOR RPT WTransType_ID = 14,15
		...
		select a.CardPointTrans_ID, a.CardPointTrans_Code, a.CardPointTrans_CreatedDate, a.CardPointTrans_CreatedBy, b.WTransType_Name, a.CardPointTrans_PointEarned,
		...
		AND a.CardPointTrans_Type in (14,15)
		AND a.CardPointTrans_MachineID LIKE '%' + @locationName  +'%'
