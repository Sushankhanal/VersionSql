/****** Object:  Procedure [dbo].[Local_Wapi_tblCardType_DeleteByID]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
create PROCEDURE [dbo].[Local_Wapi_tblCardType_DeleteByID]
