/****** Object:  Procedure [dbo].[sp_tblPayment_Header_Card_Addv2]    Committed by VersionSQL https://www.versionsql.com ******/
...
CREATE PROCEDURE [dbo].[sp_tblPayment_Header_Card_Addv2]
...
EXEC @return_value= [dbo].[Local_sp_tblPayment_Header_Card_Addv2]
		@strPOSUserCode,
@strClientUserCode,
@strCounterCode,
@strCompanyCode,
...
END CATCH
    ...
    begin
	 EXEC[dbo].[Local_sp_tblPayment_Header_Card_Addv2]
		@strPOSUserCode,
@strClientUserCode,
@strCounterCode,
@strCompanyCode,
