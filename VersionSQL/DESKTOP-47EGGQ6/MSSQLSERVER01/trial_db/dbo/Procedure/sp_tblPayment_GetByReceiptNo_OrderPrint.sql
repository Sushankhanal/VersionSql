/****** Object:  Procedure [dbo].[sp_tblPayment_GetByReceiptNo_OrderPrint]    Committed by VersionSQL https://www.versionsql.com ******/

-- exec sp_tblPayment_GetByReceiptNo_OrderPrint 'POS-01', 'comp02', 'COR00000479'
CREATE PROCEDURE [dbo].[sp_tblPayment_GetByReceiptNo_OrderPrint] (
...
BEGIN
	...
	Payment_FinalAmt, 0 as Payment_PaymentType, 0 as Payment_PayAmt, 
	0 as Payment_ReturnAmt, '' as Payment_CardNumber, 0 as Payment_CardType, 
	Payment_UserCode, 0 as Payment_AdjustmentAmt, 
	Payment_TotalTaxAmt, '' as PaymentMode_Name, Payment_Remarks,
	'' as RefundStatus,
	'' as ClientName,
	--Company_Name, Company_RegNo, Company_Address1, Company_Address2, 
	'' as PaymentMode_Name,
	...
	0 as Payment_RedeemAmt, 0 as Payment_RedeemPoint, Payment_CollectionCode,
	0 as Payment_CollectedAmt, 0 as Payment_ChangeAmt,
	ISNULL((select top 1 Table_Name from tblTable where Table_Code = H.Payment_TableCode),'') as TableName,
	Payment_SST, Payment_SC,
	'' as MemberCardNumber, '' as MobileMemberName, Payment_DiscountMode, Payment_GlobalDiscount, Payment_GlobalDiscountAmt,
	Payment_GlobalDiscountAmt as Payment_GlobalDiscountAmt1
	...
	where Payment_CounterCode LIKE '%' + @CounterCode + '%'
